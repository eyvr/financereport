...
public class ForecastCollectionTest {
    ...
    public void testNotNullArguments()
    {
        new ForecastCollection(123f, null, new ArrayList<Forecast>());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testNotNullArguments2()
    {
        new ForecastCollection(123f, mock(Month.class), null);
    }
    ...
    private Forecast getForecast(Month month) throws ParseException {
        return new Forecast(mock(DefaultMonthlyReport.class), month);
    }
}