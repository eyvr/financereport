...
public class ReportPrinterTest {
    ...
    public void setUp() throws Exception {
        ...
        MonthlyReport report1 = getMonthlyReportMock(13f, "2015-02");
        when(report1.getTotal(food)).thenReturn(2f);
        when(report1.getTotal(entertainment)).thenReturn(11f);

        MonthlyReport report2 = getMonthlyReportMock(4f, "2015-03");
    ...
    private MonthlyReport getMonthlyReportMock(float total, String monthLabel) {
